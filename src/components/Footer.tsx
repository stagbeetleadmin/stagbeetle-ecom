        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-20">
          ...
          <div className="col-span-2 lg:col-span-2 space-y-6">
            <Link href="/" className="flex items-center gap-3">
              <Logo className="h-12 w-auto text-on-surface grayscale" showText={true} />
            </Link>
            ...
            <div className="flex items-center gap-3.5 pt-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-on-surface-variant hover:text-red-600 transition-colors p-2 border border-on-surface/10 rounded-full hover:border-red-600/30 bg-surface-dim/40 flex items-center justify-center"
                aria-label="Pinterest"
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.162-.105-.949-.199-2.403.041-3.439.219-.937 1.406-5.966 1.406-5.966s-.359-.719-.359-1.781c0-1.663.967-2.911 2.168-2.911 1.024 0 1.518.769 1.518 1.688 0 1.029-.653 2.567-.992 3.992-.285 1.193.6 2.167 1.777 2.167 2.133 0 3.77-2.254 3.77-5.504 0-2.879-2.07-4.894-5.024-4.894-3.418 0-5.429 2.564-5.429 5.217 0 1.033.399 2.14.898 2.748.099.12.112.226.084.341-.092.385-.298 1.213-.338 1.379-.053.22-.172.266-.398.161-1.488-.695-2.42-2.874-2.42-4.627 0-3.763 2.737-7.22 7.892-7.22 4.143 0 7.362 2.955 7.362 6.897 0 4.117-2.597 7.431-6.207 7.431-1.213 0-2.354-.63-2.744-1.373 0 0-.599 2.282-.744 2.84-.27.973-.996 2.19-1.481 2.977 1.119.344 2.309.531 3.541.531 6.62 0 11.988-5.366 11.988-11.987C24.012 5.367 18.643 0 12.017 0z" />
                </svg>
              </a>
            </div>
          </div>
